...
public final class BlockCommand extends AbstractCommand<ParticleDemo> {
	...
	public void execute(ParticleDemo plugin, CommandHandler<ParticleDemo> handler, CommandSender sender, String label, String[] parameters) {
		...
		ParticleEffect.displayBlockCrack(id, data, offsetX, offsetY, offsetZ, amount, ((Player) sender).getLocation().add(0, 1, 0), range);
		plugin.displayMessage(sender, "§aA block crack particle effect with the specified parameters was displayed.");
	}
	...
	public String[] getParameters() {
		return new String[] { "<id>", "<data>", "<offsetX>", "<offsetY>", "<offsetZ>", "<amount>", "<range>" };
	}
	...
	public String getDescription() {
		return "Displays a block crack particle effect with the specified parameters (uses player as center)";
	}
}