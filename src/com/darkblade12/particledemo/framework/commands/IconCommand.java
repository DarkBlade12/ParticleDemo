...
public final class IconCommand extends AbstractCommand<ParticleDemo> {
	@Override
	public void execute(ParticleDemo plugin, CommandHandler<ParticleDemo> handler, CommandSender sender, String label, String[] parameters) {
		...
		ParticleEffect.displayIconCrack(id, data, offsetX, offsetY, offsetZ, speed, amount, ((Player) sender).getLocation().add(0, 1, 0), range);
		plugin.displayMessage(sender, "§aAn icon crack particle effect with the specified parameters was displayed.");
	}
	...
	public String getDescription() {
		return "Displays an icon crack particle effect with the specified parameters (uses player as center)";
	}
}